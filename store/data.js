...
export const mutations = {
  ...
  async addFeedback(state, item) {
    ...
    // }
    await addDoc(collection(db, state.goodFirebaseId), {
      name: item.name,
  ...
  async deleteFeedback(state, id) {
    await deleteDoc(doc(collection(db, state.goodFirebaseId), String(id)))
  },
  ...
  async editedFeedback(state, editedFeedback) {
    await updateDoc(doc(collection(db, state.goodFirebaseId), state.editedFeedbackId), {
